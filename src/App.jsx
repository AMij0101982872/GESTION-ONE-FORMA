...
function MainApp({ session }) {
  ...
  const pages = {
    ...
    payments:    <Payments payments={store.payments} accounts={store.accounts} translators={store.translators} companies={store.companies} onAdd={store.addPayment} onMarkPaid={store.markPaid} onDelete={store.deletePayment} rate={store.rate} deduction={store.deduction} onSetRate={store.setRate} onSetDeduction={store.setDeduction} />,
  };
